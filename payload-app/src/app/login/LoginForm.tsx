 ...
 *
 * Kept in its own module so the parent page can load it via next/dynamic with
 * { ssr: false }, which causes Next.js to emit this component's JS as a
 * separate async chunk.  That chunk is fetched after the static HTML/CSS of
 * the page has already been painted, improving LCP by removing it from the
