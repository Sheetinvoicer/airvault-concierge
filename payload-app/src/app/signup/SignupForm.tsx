...
/**
 * SignupForm — the interactive part of the signup page.
 *
 * Extracted into its own file so next/dynamic can code-split it from the
 * static page shell, reducing the JS that must be parsed before the page
 * becomes interactive.
 */
